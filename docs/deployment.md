...
The site is then at `https://<user>.github.io/okcupid-explorer/`, or under the user's custom domain, for example
`https://nicolas-huber.dev/okcupid-explorer/`. The build uses relative asset paths, so it works under any sub-path.
